...
class test
{
    ...
    public:
        ...
        bool start_test();
		test(subject new_subject) :current_subject(new_subject), current_position(question_list.begin())
		{
			for (size_t index_addiction = 1; index_addiction < list_addiction.size(); ++index_addiction)
