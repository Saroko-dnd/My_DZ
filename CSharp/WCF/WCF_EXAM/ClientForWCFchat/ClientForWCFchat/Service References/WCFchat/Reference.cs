...
namespace ClientForWCFchat.WCFchat {
    ...
    public interface IChatService {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, IsInitiating=false, Action="http://tempuri.org/IChatService/Message")]
        System.Threading.Tasks.Task MessageAsync(string CurrentMessage, string ClientName);
    ...
    public partial class ChatServiceClient : System.ServiceModel.DuplexClientBase<ClientForWCFchat.WCFchat.IChatService>, ClientForWCFchat.WCFchat.IChatService {
        ...
        public void Message(string CurrentMessage, string ClientName) {
            base.Channel.Message(CurrentMessage, ClientName);
        }
        
        public System.Threading.Tasks.Task MessageAsync(string CurrentMessage, string ClientName) {
            return base.Channel.MessageAsync(CurrentMessage, ClientName);
        }
